  ...
  return (
    <div className="flex items-center flex-col py-24 lg:min-h-screen relative justify-center w-full px-4 md:px-12">
      ...
      <motion.div
        ...
        transition={{ delay: 2.4, duration: 1.5, type: "tween" }}
        className="z-20"
      >
        <div className="w-full flex my-5 items-center justify-center">
          <div className="bg-[#1a1a1a] gap-2 rounded-full py-2 md:px-6 px-4 w-fit flex md:flex-row flex-col items-center">
            ...
            <div className="flex gap-2 text-sm md:text-base">
              ...
              <span className="text-[#b6ff9c] font-semibold cursor-pointer" onClick={() => navigateTo("dashboard")}>Learn more</span>
            </div>
          </div>
        </div>
        <h1 className="text-[54px] leading-[1] mb-4 md:text-[64px] w-full lg:text-[76px] text-center font-bold">
          Scale your Business
          <br className="lg:block hidden" /> Growth with{" "}
          <span className="bg-clip-text text-transparent bg-gradient-to-b from-lime-400 via-white to-purple-500">
            SKC
          </span>
        </h1>
        <Paragraph
          content="Take your business to new heights with our cutting-edge SaaS solutions!"
          center
        />
      </motion.div>
      <motion.div
        ...
        transition={{ delay: 2.8, duration: 1.5, type: "spring" }}
        className="flex justify-center w-full flex-col md:flex-row z-10 my-8 items-center gap-3"
      >
        <Button content="Get started" secondary widthFull={false} onClick={() => navigateTo("dashboard")} />
        <Button content="Sign up" primary widthFull={false} onClick={() => navigateTo("dashboard")} />
      </motion.div>
    </div>
  );
};
